...
## Memory — AI身份与长期记忆
- [identity](memory/identity.md) — AI角色定位、职责边界、工作风格
- [preferences](memory/preferences.md) — 输出偏好、沟通习惯
- [thinking](memory/thinking.md) — 标准思考流程（八步链）
- [decision](memory/decision.md) — 决策原则（制度/引用/输出优先级）
...
## Workflow — 标准化工作流程
- [工作安排生成](workflow/工作安排生成.md) — 每日安排标准流程
- [制度查询分析](workflow/制度查询分析.md) — 制度检索与分析流程
- [领导安排处理](workflow/领导安排处理.md) — 任务拆解+跟踪闭环
- [信息记录更新](workflow/信息记录更新.md) — 对话结束更新流程

## Templates — 统一输出格式
- [工作安排模板](templates/工作安排模板.md) — 安排输出格式
